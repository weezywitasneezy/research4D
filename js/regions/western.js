...
function createFireIslands(scene, labelSystem) {
    ...
    function createVolcanicIsland(radius, height, x, z, scale = 1.0) {
        ...
        // Base island with increased segments for smoother geometry
        const baseGeometry = new THREE.CylinderGeometry(radius, radius * 1.2, height, 32);
        ...
        // Volcano cone with increased segments
        const volcanoGeometry = new THREE.ConeGeometry(radius * 0.7, height * 1.2, 32);
        ...
        // Lava crater with increased segments
        const craterGeometry = new THREE.CylinderGeometry(radius * 0.3, radius * 0.4, height * 0.2, 32);
        ...
        const particleCount = 100; // Increased particle count for more detail
        ...
        const smokeCount = 60; // Increased smoke count for more detail
        ...
        // Add some rocky outcrops around the base with increased detail
        for (let i = 0; i < 10; i++) {
